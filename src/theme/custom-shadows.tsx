...
import { grey, info, error, common, success, warning, primary, secondary } from './palette';
...
export function customShadows(mode: 'light' | 'dark') {
  ...
  return {
    ...
    //
    primary: `0 8px 16px 0 ${alpha(mode === 'dark' ? primary.main : primary.main, 0.24)}`,
    info: `0 8px 16px 0 ${alpha(info.main, 0.24)}`,
    secondary: `0 8px 16px 0 ${alpha(mode === 'dark' ? secondary.main : secondary.main, 0.24)}`,
